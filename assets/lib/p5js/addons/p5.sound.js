...
fft = function () {
   ...
   *
   *    stroke(255);
   *    text('Freq: ' + g_round(freq)+'Hz', 10, 10);
   *
   *    isMouseOverCanvas();
   *  }
   *
  ...
  /**
     ...
     *  textSize(40);
     *  text("centroid: "+g_round(spectralCentroid)+" Hz", 10, 40);
     *}
     * </code></div>
     */
...
reverb = function () {
   ...
   *  the producers in the <code>.impulses</code> Array. Accepts a parameter
...
looper = function () {
   ...
   *  after the current g_round of playback completes.
   *
   *  @method  noLoop
   */
